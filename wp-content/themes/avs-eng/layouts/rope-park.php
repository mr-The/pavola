  ...
  <div class='infoblock-marshrut-box'>
    <div class='infoblock-inform_marshrut'>
      ...
      <div class='infoblock-inform-text'>
        ...
        <div class='infoblock-inform-description'>
          <p>
            Тур для тех, кто хочет ближе узнать старинный город Сортавала, а также совершить трекинг к водопадам Белые
            мосты!<br>
  ...
  <div class='video-text'>
    <div class='text-content'>
      <p><strong>Продолжительность:</strong> 5 дней/4 ночи и 9 дней/8 ночей.<br>
        ...
        <br>
        <strong>Транспорт:</strong> собственный автомобиль / каршеринг / индивидуальный трансфер от «Игора Тур» (+ж/д —
        альтернатива).
      </p>
    </div>
    <div class='video-content'>
      <iframe width="560" height="300" src="https://www.youtube.com/embed/Yrajz_FFnec" title="" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        allowfullscreen>
      </iframe>
    </div>
...
<section class="number-block">
  ...
  <div class='number-box-wraper container row'>
    ...
    <div class='number_conteiner_text'>
      ...
      <div class='number_group_text'>
        <div class='number_icon_block'>
          <img class='number_icon' src="<?php bloginfo('template_url'); ?>/images/Group1.png" style='width:55px;'
            alt='icon'>
        </div>
      ...
      <div class='number_group_text'>
        <div class='number_icon_block'>
          <img class='number_icon' src="<?php bloginfo('template_url'); ?>/images/Group2.png" style='width:55px;'
            alt='icon'>
        </div>
        <div class='number_text-box'>
          <div class='number_title_block'>
          ...
          <div class='number_text_block'>
            <p>
              Каждый снегоход проходит регулярное техническое обслуживание, а также тщательный осмотр и проверку работы
              агрегатов после каждого заезда
            </p>
          </div>
        </div>
      </div>
      ...
      <div class='number_group_text'>
        <div class='number_icon_block'>
          <img class='number_icon' src="<?php bloginfo('template_url'); ?>/images/Group3.png" style='width:55px;'
            alt='icon'>
        </div>
        <div class='number_text-box'>
          <div class='number_title_block'>
          ...
          <div class='number_text_block'>
            <p>
              Широкая гусеница обладает непревзойденными качествами при движении по глубокому снегу на низкой скорости.
              Идеально для карельских лесов.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class='number_conteiner_text'>
      ...
      <div class='number_group_text'>
        ...
        <div class='number_text-box'>
          ...
          <div class='number_text_block'>
            <p>
              LYNX 59 YETI 600 ACE — один из самых комфортных снегоходов. Четырехтактный двигатель ROTAX 600 ACE объемом
              600 куб. см.
            </p>
          </div>
        </div>
